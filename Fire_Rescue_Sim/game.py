...
class FireRescueSimulation:
    ...
    def _update_ui(self):
        ...
        for i, pt in enumerate(self.rescuers):
            if i == 1:  # Second rescuer
        ...
        if self.victim and self.victim_count == 1:
        ...
        pygame.draw.rect(self.display, (139, 69, 19), pygame.Rect(20, self.h - 20, BLOCK_SIZE, BLOCK_SIZE))
